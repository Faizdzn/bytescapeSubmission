<hr>
<footer class="flex flex-col gap-6 justify-center my-[30px]">
    <div class="mx-auto flex items-center gap-4 text-green text-2xl">
        <img src="/assets/logo.svg" width="21" alt="">
        <span>EduPoint</span>
    </div>
